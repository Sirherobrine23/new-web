...
Windows/MacOS/Linux:
<form class="video-container" action="" method="GET"><video preload="none" class="jlplayer-video" controls autoplay ><source src="/assets/images/Mac-Guide/etcher.mp4"></video></form>

Windows:
<form class="video-container" action="" method="GET"><video preload="none" class="jlplayer-video" controls autoplay ><source src="/assets/images/Mac-Guide/rufus.mp4"></video></form>
...
<form class="video-container" action="" method="GET"><video preload="none" class="jlplayer-video" controls autoplay ><source src="/assets/images/Mac-Guide/acelera_HD 720p.mp4"></video></form>